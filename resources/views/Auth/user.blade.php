            ...
            $(document).on('click', '#edit-message', function() {
                ...
                $.get(url, function(result) {
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label for="">Name</label>
                            <input type="text" id="name" name="name" class="form-control form-primary" value="` +
                        result.name +
                        `">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="">Username</label>
                            <input type="text" name="username" id="username" class="form-control form-primary" value="` + result
                        .username + `">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="">Password</label>
